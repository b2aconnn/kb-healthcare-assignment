...
public record DailySummaryInfo(
    String recordkey,
    LocalDate date,
    Integer totalSteps,
    ...
    public static class Builder {
        ...
        public DailySummaryInfo build() {
            return new DailySummaryInfo(recordkey, date, totalSteps, totalCalories, totalDistance, sourceType);
        }
    }
}